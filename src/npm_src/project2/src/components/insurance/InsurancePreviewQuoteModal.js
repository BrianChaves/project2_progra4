...
function InsurancePreviewQuoteModal({formik, vehicleList, coverageList, paymentScheduleList, paymentList, createErrors, setCreateErrors}) {
    ...
    return (
        <div class="modal fade" id="previewQuoteModal" tabindex="-1" aria-labelledby="previewQuoteModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="previewQuoteModalLabel">Create Insurance</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row col-12 justify-content-between m-0">
                        <a href="#" class="btn btn-secondary col-4 fw-bold" data-bs-toggle="modal" data-bs-target="#createInsuranceModal" data-bs-dismiss="modal">Go Back</a>
                        <button type="button" class="btn btn-primary col-4 fw-bold" onClick={handleQuoteCreate}>Add Insurance</button>
                    </div>
                </div>
                </div>
            </div>
